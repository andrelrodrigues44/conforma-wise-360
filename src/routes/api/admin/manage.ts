...
function tableConfig(table: string) {
  const configs: Record<string, string[]> = {
    ...
    marketing_contents: ["campaign_id", "canal", "formato", "linha_comercial", "titulo", "legenda", "cta", "criativo_brief", "criativo_url", "criativo_urls", "criativo_alt", "data_publicacao", "status"],
